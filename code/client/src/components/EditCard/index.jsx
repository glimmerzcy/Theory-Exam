...
class EditCard extends React.Component {
    ...
    autoH = () => {
        let { title_height, textarea_ref } = this.state,
            { current } = textarea_ref
    ...
    render() {
        let { question, section, id } = this.props,
        ...
        return (
            <div className="ec-content">
                ...
                <div className="ec-items">
                    ...
                    {type === "mc" && question.options().length < 6 && (
                        <div
                            className="ec-add-item pointer"
                            title="添加一个新选项"
                            onClick={() => question.add()}
                        >
                            +添加选项+
                        </div>
                    )}
